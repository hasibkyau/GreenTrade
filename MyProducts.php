...
<?php
    ...
    <div class='row'>
            <h2 class="mx-auto border col-lg-10 ">My Products</h2>
         </div>
            ...
            if (mysqli_num_rows($result) > 0) {
                while ($product = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<p class='card-text m-0'>" . "Price: " . $product['price'] .  "</p>";
                    echo "<p class='card-text m-0'>" . "Quantity: " . $product['quantity'] .  "</p>";
